          ...
          <ScrollView>
            <View style={styles.content}>
              <View style={[styles.qrCode]}>
                ...
                />
                <CommonText style={{ color: theme.text, paddingHorizontal: 36 }}
              ...
              <View style={styles.controls}>
                <CommonTouchableOpacity
                  ...
                  <CommonText style={{ color: theme.text }}>{t("wallet.receive.copy")}</CommonText>
                </CommonTouchableOpacity>
                <CommonTouchableOpacity
                  style={styles.element}
                  onPress={async () => {
                  ...
                  <CommonText style={{ color: theme.text }}>{t("wallet.receive.share")}</CommonText>
                </CommonTouchableOpacity>
              </View>
            </View>
          </ScrollView>
