...
function Alert({ title, message, icon, confirm, onConfirm }) {
  ...
  return (
    <View style={[styles.containerAlert]}>
      <View style={[styles.contentAlert, { backgroundColor: theme.alertBackground }]}>
        <CommonText style={{ ...styles.title, color: theme.text }}>{title}</CommonText>
        <View style={styles.img_container}>
          <CommonImage source={icon} style={styles.img} />
        </View>
        <CommonText style={{ ...styles.text, color: theme.text }}>{message}</CommonText>
